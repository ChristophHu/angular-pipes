...
// import * as data from './fakeusers'

describe('TitlePipe', () => {
  
  let pipe: TitlePipe
  var fakeusers = require('fakeusers.json')
  ...
  it('if gender is null or "" ', () => {
    const str = pipe.transform(fakeusers[0].first_name, null, null);
    expect(str).toBe(fakeusers[0].first_name);
  });
